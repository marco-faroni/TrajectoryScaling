...
lambdaU = 1e0; 
lmd = 1e7;
lambdaTRJ = [lmd/Np, 1e5];
Kclik = blkdiag(5e1*eye(robot.df));
...
Wsc(1:task.size,1:task.size) = Np*1e0*Wsc(1:task.size,1:task.size); % peso leggermente di pi� il primo istante
